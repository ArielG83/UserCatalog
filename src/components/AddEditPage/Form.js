...
const Form = ({user, submit}) => {
    ...
    const [profileImage, setProfileImage] = useState(!isNew ? user.profileImage : '')
        ...
        <View style={styles.container}>
            ...
            <View style={styles.form}>
                <Input
                    ...
                    inputContainerStyle={{...styles.textInput, borderColor: fullNameError == '' ? colors.grey : colors.red}}
                ...
                <Input
                    ...
                    inputContainerStyle={{...styles.textInput, borderColor: emailError == '' ? colors.grey : colors.red}}
                ...
                <View style={styles.submitWrap}>
                    <Text style={styles.validationError}>{validationErrorMsg && `* ${validationErrorMsg}`}</Text>
                    <Button
                        title="Save"
                        onPress={save}
